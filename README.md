...
Интеллектуальная система автоматического мониторинга и анализа отзывов о компании ПАО «ТНС энерго НН» в социальных сетях и на новостных сайтах.
...
- **Автоматический сбор отзывов** из:
  ...
  - Яндекс Дзен и новостные сайты (web scraping)
...
2. **Дашборд** - статистика по отзывам и последние записи
